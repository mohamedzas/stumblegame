'use strict'; {
    ...
    js_cols.RedBlackSet.prototype.deleteFixup =
        function(x) {
    ...
    js_cols.RedBlackSet.prototype.predeccessor_ = function(x) {
        if (x.left !=
            this.sentinel) return this.max(x.left);
        var y = x.parent;
    ...
    js_cols.RedBlackSet.prototype.get_ = function(key) {
        var x = this.root;
        while (x != this.sentinel && this.compare(x.key,
                key) != 0)
    ...
    js_cols.RedBlackSet.prototype.insertAll = function(col) {
        ...
        else if (js_cols.typeOf(col.getValues) ==
            "function") {
    ...
    js_cols.RedBlackSet.prototype.some = function(f,
        opt_obj) {
    ...
    js_cols.RedBlackSet.prototype.map = function(f, opt_obj) {
        ...
        for (var n = this.min(this.root); n !=
            this.sentinel; n = this.successor_(n)) rv.push(f.call(opt_obj, n.key, n.key, this));
        return rv
    };
